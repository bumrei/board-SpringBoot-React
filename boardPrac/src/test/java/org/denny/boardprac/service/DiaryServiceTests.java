...
import org.denny.boardprac.dto.DiaryPictureDTO;
import org.denny.boardprac.dto.PageRequestDTO;
import org.denny.boardprac.dto.PageResponseDTO;
import org.denny.boardprac.entity.DiaryPicture;
...
public class DiaryServiceTests {
    ...
    public void registerTest() {
        ...
        List<String> tags = IntStream.rangeClosed(1,3).mapToObj(j -> "tag + " + j).collect(Collectors.toList());
